...
### **Live Demo Check out the live demo of the project:** https://rakeshjobbiapp.ccbp.tech

### **About Key Features:** User Authentication, Job Search, Job Details, Favorite Jobs, Responsive Design

### **Technologies Used:** Frontend: React, CSS | Backend: Node.js, Express | Database: SQLite | Styling: CSS | Authentication: JWT
